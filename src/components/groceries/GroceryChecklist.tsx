    ...
    <div className="w-full max-w-2xl mx-auto bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden font-sans text-slate-100 selection:bg-indigo-500/30">
      ...
      <div className="p-6 bg-slate-950 border-t border-slate-800 space-y-4">
        ...
        <button
          ...
          className="mt-6 w-full flex items-center justify-center rounded-xl bg-indigo-600 text-slate-100 font-bold py-4 px-4 hover:bg-indigo-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-[0_0_20px_rgba(79,70,229,0.15)] hover:shadow-[0_0_25px_rgba(79,70,229,0.3)]"
        >
          {loading ? (
             <>
